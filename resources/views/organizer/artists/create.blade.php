<x-app-layout>
    <div class="max-w-3xl mx-auto py-10">
        <div class="bg-white shadow-lg rounded-xl p-8">
            <h2 class="text-2xl font-bold text-center text-gray-800 mb-6">Create New Artist</h2>
            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('organizer.artist.store') }}"
                class="space-y-6">
                @csrf
