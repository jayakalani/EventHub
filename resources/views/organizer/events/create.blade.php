    ...
    <div class="max-w-3xl mx-auto p-8 bg-white shadow-lg rounded-2xl">
        ...
        <form method="POST" action="{{ route('organizer.events.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                @error('hosted_by') <p class="text-sm text-red-600 mt-1">{{ $message }}</p> @enderror
            </div>
            ...
            <div>
                ...
                <input id="no_of_seats" type="number" name="no_of_seats" value="{{ old('no_of_seats') }}"
                       class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                       required>
                @error('no_of_seats') <p class="text-sm text-red-600 mt-1">{{ $message }}</p> @enderror
            </div>
            ...
            {{-- Contact Person --}}
            <div>
                <label for="contact_person" class="block text-sm font-medium text-gray-700">Customer Relations Officer</label>
                ...
                @error('contact_person') <p class="text-sm text-red-600 mt-1">{{ $message }}</p> @enderror
            </div>
