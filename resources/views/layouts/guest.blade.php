...
<body class="font-sans text-gray-900 antialiased dark:text-gray-100">
    <div
        class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 py-8 bg-gray-100 dark:bg-gray-900">
        <div class="mt-5 mb-5">
            <a href="/"
                class="text-2xl font-bold text-primary dark:text-primary-light hover:opacity-80 transition">
                {{ config('app.name') }}
            </a>
        </div>
