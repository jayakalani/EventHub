        ...
        <main class="flex flex-col-reverse lg:flex-row max-w-7xl w-full rounded-2xl overflow-hidden shadow-xl">
            ...
            <div class="flex-1 px-8 lg:p-16">
                ...
                <div class="mb-10 animate-fade-in">
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-xl">
                        Smart event management system for ticketing, seat allocation, and seamless organization of concerts, theatre shows, and large-scale events.
                    </p>

                    <!-- BUTTONS -->
                    <div class="flex flex-col sm:flex-row gap-4">
                        @auth
                            <a href="/dashboard" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl shadow-md">
                                Dashboard
                            </a>
                        @else
                            <a href="{{ route('login') }}" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl shadow-md">
                                Sign In
                            </a>
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="backdrop-blur-lg bg-white/60 dark:bg-gray-800/60 p-6 rounded-xl shadow-md hover:scale-105 transition">
                        <div class="text-3xl mb-3">🎫</div>
                        <h3 class="font-semibold text-lg">Ticketing</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-300">Manage and generate event tickets easily.</p>
                    </div>
            ...
            <div class="w-full lg:w-1/2 flex items-center justify-center p-6">
                ...
                <div class="rounded-2xl overflow-hidden shadow-lg">
                    <img 
                        src="{{ asset('cover-images/event-hub-illustration.png') }}" 
