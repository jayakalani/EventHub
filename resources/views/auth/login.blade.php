    ...
    <div class="w-full px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
            ...
            <div class="invisible md:visible text-center">
                <div class="mb-8">
                    <img src="{{ asset('cover-images/event-hub-illustration.png') }}" alt="Insurance Illustration"
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}"
                                    class="text-sm text-primary dark:text-primary-light hover:text-primary-dark dark:hover:text-primary font-semibold transition">Forgot
                                    password?</a>
                            @endif
                        </div>
                        <!-- submit button -->
                    ...
                    <div class="mt-8 text-center border-t border-gray-300 dark:border-gray-600 pt-6">
                        <p class="text-gray-600 dark:text-gray-400">
                            ...
                            <a href="{{ route('register') }}"
                                class="font-semibold text-primary dark:text-primary-light hover:text-primary-dark dark:hover:text-primary transition">Create
                                one now</a>
                        </p>
                    </div>
                </div>
