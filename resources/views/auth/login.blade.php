    ...
    <div class="w-full px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
            ...
            <div class="lg:hidden text-center animate-[fadeIn_0.5s_ease-out]">
                ...
                <h2 class="text-2xl font-bold text-primary dark:text-primary-light">Welcome to EventHub</h2>
            ...
            <div class="hidden lg:block animate-[fadeIn_0.6s_ease-out]">
                ...
                <div class="mt-10 text-center lg:text-left">
                    ...
                    <p class="mt-4 text-gray-600 dark:text-gray-400 text-lg leading-relaxed max-w-md">
                        Discover, join, and manage events effortlessly. Your next great experience starts here.
                    </p>
                ...
                <div class="relative overflow-hidden rounded-3xl bg-white/80 p-6 sm:p-8 md:p-10 shadow-2xl ring-1 ring-gray-200/60 backdrop-blur-xl transition-shadow duration-300 hover:shadow-[0_20px_60px_-15px_rgba(37,99,235,0.15)] dark:bg-gray-800/80 dark:ring-gray-700/60 dark:hover:shadow-[0_20px_60px_-15px_rgba(59,130,246,0.1)]">
                    ...
                    <div class="relative">
                        <div class="mb-8">
                            ...
                            <h3 class="mt-4 text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Welcome Back</h3>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-5">
                            ...
                            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between pt-1">
                                <label for="remember_me" class="flex items-center gap-2.5 cursor-pointer group/check">
                                    ...
                                    <span class="text-sm text-gray-600 dark:text-gray-400 group-hover/check:text-gray-800 dark:group-hover/check:text-gray-300 transition-colors">Remember me</span>
                                </label>
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}"
                                        class="text-sm text-primary dark:text-primary-light hover:text-primary-dark dark:hover:text-primary font-semibold transition-colors duration-200 hover:underline underline-offset-2">Forgot
                                        password?</a>
                                @endif
                            </div>
                            {{-- submit button --}}
                        ...
                        <div class="mt-8 text-center border-t border-gray-200 dark:border-gray-700 pt-6">
                            <p class="text-gray-600 dark:text-gray-400">
                                ...
                                <a href="{{ route('register') }}"
                                    class="font-semibold text-primary dark:text-primary-light hover:text-primary-dark dark:hover:text-primary transition-colors duration-200 hover:underline underline-offset-2">Create
                                    one now</a>
                            </p>
                        </div>
                    </div>
