                    ...
                    <div
                        ...
                        <div class="p-4">
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                ...
                                <!-- Toggle -->
                                <form action="{{ route('organizer.artists.toggleActive', $artist->id) }}" method="POST"
                                    class="col-span-3">
                                    @csrf
