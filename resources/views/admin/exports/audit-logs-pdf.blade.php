            ...
            <tbody>
                @foreach($logs as $log)
                    <tr>
                        ...
                        <td>{{ $log->model_id }}</td>
                        <td class="small-text"><pre style="margin: 0; white-space: pre-wrap;">{{ $log->old_values ?? '-' }}</pre></td>
                        <td class="small-text"><pre style="margin: 0; white-space: pre-wrap;">{{ $log->new_values ?? '-' }}</pre></td>
