...
<body>
    @php
        ...
        $sectionHints = [
            ...
            'overview' => 'Platform growth, revenue, tickets, and category trends.',
            'revenue' => 'Income trends, refunds, and contribution by event.',
            'tickets' => 'Sales volume, conversion, and category performance.',
            'events' => 'Event status mix, growth, and category performance.',
            'users' => 'Account health, roles, and registration trends.',
            'payments' => 'Payment status, methods, and revenue trend.',
            ...
            'support' => 'Inquiry and complaint workload for the selected CRO, organizer, and event.',
