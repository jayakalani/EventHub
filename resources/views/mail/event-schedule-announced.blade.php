...
<head>
    ...
    <title>Event date announced</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;background:#ffffff;border:1px solid #e2e8f0;border-radius:16px;overflow:hidden;">
                    <tr>
                        <td style="background:linear-gradient(135deg,#4f46e5,#6366f1);padding:28px 32px;color:#ffffff;">
                            <p style="margin:0 0 8px;font-size:13px;opacity:0.9;text-transform:uppercase;letter-spacing:0.08em;">Date announced</p>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 24px;font-size:15px;line-height:1.6;color:#475569;">
                                An event you saved now has a confirmed schedule.
                            </p>
                            ...
                            <p style="margin:0;font-size:14px;line-height:1.6;color:#475569;">
                                View the event and book tickets from
                                <a href="{{ route('attendee.events.show', $event) }}" style="color:#4f46e5;text-decoration:none;font-weight:600;">Event details</a>.
                            </p>
                        </td>
                    </tr>
                </table>
