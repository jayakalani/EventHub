...
class GenerateOrganizerReportRequest extends FormRequest
{
    ...
    {
        $catalog = app(OrganizerReportRegistry::class)->catalogFor($this->user());
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator) {
            ...
            $definition = app(OrganizerReportRegistry::class)->definitionFor($this->user(), $reportKey);
