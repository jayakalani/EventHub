<x-app-layout>
    @php
        ...
        $filterScope = $hasActiveFilters ? 'Within current filters' : 'Your assigned events';

        $kpis = [
            [
                'label' => 'Matched',
                'value' => $stats['matched'],
                'sub' => $hasActiveFilters ? 'After active filters' : 'Events assigned to you',
    ...
    <div class="cro-events relative isolate overflow-hidden py-5 sm:py-6">
        ...
        <div class="mx-auto max-w-7xl space-y-5 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="relative flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        <div class="min-w-0">
                            <div class="flex items-center gap-2.5">
                                ...
                                <div class="min-w-0">
                                    <p class="truncate text-sm font-semibold text-slate-700">Assigned catalog</p>
                            ...
                            <p class="mt-1.5 text-sm text-slate-500">
                                Events where you are the contact person ·
                                {{ now()->format('l, M j, Y') }}
                            </p>
                        </div>

                        <div class="flex flex-wrap items-center gap-2 sm:justify-end">
                            <a href="{{ route('cro.events.export.csv', request()->query()) }}"
                            ...
                            <a href="{{ route('cro.events.export.pdf', request()->query()) }}"
                                class="btn-smooth inline-flex items-center gap-1.5 rounded-lg border border-white/70 bg-white/50 px-3 py-2 text-xs font-semibold text-slate-700 shadow-sm backdrop-blur hover:border-indigo-200 hover:bg-white/80 sm:text-sm">
            ...
            <section class="glass-panel !rounded-2xl p-4 sm:p-5">
                ...
                <form method="GET" action="{{ route('cro.events.index') }}"
            ...
            <section class="glass-card overflow-hidden !p-0 !rounded-2xl">
                <div class="flex flex-col gap-2 border-b border-white/60 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
                    <div>
                        <h2 class="text-sm font-semibold text-slate-900">Assigned events</h2>
                                ...
                                <tr class="btn-smooth align-middle hover:bg-white/45">
                                    ...
                                    <td class="px-4 py-4 sm:px-6">
                                        <div class="flex justify-end">
                                            <a href="{{ route('cro.events.show', $event->id) }}"
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-16 text-center">
                                        ...
                                        <p class="mt-1 text-xs text-slate-500">
                                            @if ($hasActiveFilters)
                                                Try another organizer, status, or date range.
                                            @else
                                                Events appear here when an organizer assigns you as the contact person.
                                            @endif
                                        </p>
                                    </td>
                                </tr>
